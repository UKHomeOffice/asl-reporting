...
## Sprint Completion: A broken test pipeline meant we could not deploy any new functionalities at the end of this Sprint, but the good news is that the test pipeline is now back in action. This is why you're getting the report a 'little' later than usual.
