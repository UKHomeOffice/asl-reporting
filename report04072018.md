...
* Developed changes to licenced premises and project directory which were shown at the user research session

## About to Do/Doing
* Analysis of outpus from the establishment user research session
* Design thinking around the statuses for amendement tasks
* Delivery of the end-to-end amendment journey (no middle)

## Things to be aware of
* The risk exposure figure has slightly increased.  This is the result of the removal of one large risk: lack of access to data; and the addition of another risk: sufficient functionality cannot be delivered to turn off ASPel in Aug 2019. This risk has been higlighted now so that all the necessary measures can be put in place to manage and mitigate it.
