...
5) Standardise authourisation for rehoming and set free for efficiencies in time and effort.
6) Continue Named Person improvements 
7) NTS publishing improvements
8) Design a single GA Standard protocol
9) We will insert a link from a Named Person application page to the guides stored on the gov.uk site, for user convenience.
