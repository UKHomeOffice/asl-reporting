...
Possible actions and mitigations to address this will be discussed at the next risk management meeting. 

## Just Done
* Several members of the team attended the ASRU conference in Lancaster
* View establishment details and view licenced premises (ASRU view)
...
## Sprint Planning
* We planned the following issues in sprint planning today [Link to Issues in Jira](https://jira.digital.homeoffice.gov.uk/secure/RapidBoard.jspa?rapidView=261)    [\(Cached Image\)](graphs/sprint23052018.png)
