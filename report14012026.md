...
1) Seven new pages have been added to the Cat E Pil tickets improvements task, each placed behind a feature flag.
2) Additionally, seven HBA replacement tickets were included under the same feature flag.
...
4) The comparison page, or 'see what's changed', now displays updates correctly when edits are made.
...
Interesting facts about Tamarins: 
...
3. Start NP work to update screens, from UAT1.
4. Continue AWS upgrade.
5. Continue SP content work (for fixed SP4).
6. Build DOCX exporter for NTS.
7. Continue Cat E PIL.
8. Write HBA e2e test scripts.
