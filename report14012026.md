...
2) Additionally, seven HBA replacement tickets were completed also behind a feature flag.
...
4) The comparison page, or 'see what's changed', now displays updates correctly when edits are made in the training records section.
