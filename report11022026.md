...
# Completed this Sprint, (21 stories, tasks and bugs out of 36 planned, done to prioritise bugs)
1) Four standard protocols tickets completed during the Sprint including a feature falg to hide features until all SP work is done and ready for users to test.
2) Three tickets were done for the NTS DOCX document including a feature flag until all work is ready for user testing
3) HBA replacement was tested end to end, signifying the deployment of that feature into production
4) We added the 2027 Bank holidays to ASPeL as part of maintenance
5) We added rules for 'new' and 'added' tags on PPL
